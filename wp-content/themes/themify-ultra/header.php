						...
						<div class="navbar-wrapper clearfix">
							...
							<?php if ($search_form!==false ){
									if ($search_form  === 'search_form') {
										...
										echo '<a class="search-button tf_vmiddle tf_inline_b" href="#">'.themify_get_icon('search','fa').'<span class="screen-reader-text">'.__('Search','themify').'</span></a>';
									}
							}?>
