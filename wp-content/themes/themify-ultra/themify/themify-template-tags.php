...
if (!function_exists('themify_theme_feed')){
	...
	if(!themify_check($key,true)){
	    ...
	    ?>
	    <div class="rss<?php if(isset($args['class'])):?> <?php echo $args['class']?><?php endif;?>"><a<?php if(isset($args['link_class'])):?> class="<?php echo $args['link_class']?>"<?php endif;?> href="<?php themify_theme_feed_link($key) ?>"><?php if(isset($args['icon'])):?><?php echo themify_get_icon($args['icon'])?><?php endif;?><?php echo !empty($text)?$text:'<span class="screen-reader-text">'.__('RSS','themify').'</span>';?></a></div>
	    <?php
	}
    }
}
