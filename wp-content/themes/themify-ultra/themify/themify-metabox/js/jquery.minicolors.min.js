...
typeof b.swatches[k]){e=b.swatches[k].name;var B=b.swatches[k].color}else e="",B=b.swatches[k];var l=B;B=y(B)?r(B,!0):u(x(B,!0));d('<li class="minicolors-swatch minicolors-sprite"><span class="minicolors-swatch-color tf_abs" title="'+e+'"></span></li>').appendTo(h).data("swatch-color",l).find(".minicolors-swatch-color").css({backgroundColor:E(B),opacity:B.a});b.swatches[k]=B}}b.inline&&a.parent().addClass("minicolors-inline");g(a,!1);a.data("minicolors-initialized",!0)}}function q(a){var b=a.parent();
