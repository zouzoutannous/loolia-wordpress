        ...
        file: {
            ...
            browse(uploader, input,  self, type) {
                ...
                uploader.addEventListener('click', function (e) {
                    ...
                    if('video'===type && !window.wp.mediaelement){//tmp fix
                        let currentIndex = 0;
                        const jsKeys = Object.keys(themify_vars['media']['js']),
                            ...
                            recurSiveLoad = function (index, force) {
                                ...
                                if (key !== 'wp-mediaelement' || force === true) {
                                    topWindow.Themify.LoadAsync(themify_vars['media']['js'][key]['src'], function () {
                                            ++currentIndex;
                                            if (currentIndex < len) {
                                    ...
                                    topWindow.Themify.mediaCssLoad(function () {
                                            ...
                                            if(nextsearch.nextElementSibling!==null){
												...
												if(nextsearch!==null){
													...
													if (is_post) {
                                                        ...
                                                        nextsearch.addEventListener('input', function (e) {
