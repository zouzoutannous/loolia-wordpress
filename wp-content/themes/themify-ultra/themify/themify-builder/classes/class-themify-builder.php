...
if (!class_exists('Themify_Builder')) :
	...
	function get_builder_output( $post_id, $content = '' ) {
	    ...
	    if ( Themify_Builder_Model::is_gutenberg_active() && Themify_Builder_Gutenberg::has_builder_block( $post->post_content ) ) {
		...
		elseif ( ThemifyBuilder_Data_Manager::has_static_content( $post->post_content ) ) {
	...
	public function inline_css(){
		...
		if($is_sticky!==false){
			$p='.sticky-wrapper.tb_sticky_scroll_active [data-sticky-active] .hide-on-stick{display:none}';
			if($is_sticky==='m'){
